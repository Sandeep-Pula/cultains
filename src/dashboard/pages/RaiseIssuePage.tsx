...
const isClosedTicket = (status: SupportThread['status']) => status === 'resolved' || status === 'closed';
...
export const RaiseIssuePage = ({
  ...
  const openTickets = useMemo(
    () => supportThreads.filter((ticket) => !isClosedTicket(ticket.status)),
    [supportThreads],
  );
